...
export const Route = createFileRoute('/user/config/tranches-horaires')({
  loader: async () => {
    const response = await fetch('/mocks/user-page.json')
    return (await response.json()) as UserData
  },
  component: AvailabilityConfigPage,
})

function AvailabilityConfigPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl">Configuration tranches horaires</CardTitle>
        </CardHeader>
