...
export const Route = createFileRoute('/user/config/zone-activite')({
  loader: async () => {
    const response = await fetch('/mocks/user-page.json')
    return (await response.json()) as UserData
  },
  component: ActivityZoneConfigPage,
})

function ActivityZoneConfigPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl">Configuration zone d'activite</CardTitle>
        </CardHeader>
